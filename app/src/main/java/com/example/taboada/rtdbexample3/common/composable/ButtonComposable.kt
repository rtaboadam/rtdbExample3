...
fun ButtonComposablePreview() {
    Column() {
        BasicButton(text = AppText.chats, modifier = Modifier ) {}
        Spacer(modifier = Modifier)
        BasicTextButton(text = AppText.chats, modifier = Modifier ) {}
        Spacer(modifier = Modifier)
        DialogConfirmButton(text = AppText.chats) {}
        Spacer(modifier = Modifier)
        DialogCancelButton(text = AppText.chats) {}
    }
}
